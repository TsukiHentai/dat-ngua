...
vitri=0
for i in range(n):
    if ds[i].tien()>max and ds[i].ma[0]=="D":
        max=ds[i].tien()
        vitri=i
        demkinhdoanh+=1
if demkinhdoanh==0:
    ...
    print("%s %s %d %d %d %d"%(ds[vitri].ma,ds[vitri].ten,ds[vitri].dauky,ds[vitri].cuoiky,ds[vitri].cuoiky-ds[vitri].dauky,ds[vitri].tien()))